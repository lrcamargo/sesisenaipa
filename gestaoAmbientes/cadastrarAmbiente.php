    ...
    <form action="salvarAmbiente.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" name="capacidade" class="form-control"
                   placeholder="Ex: 30" min="1" max="999">
        </div>
        <div class="form-group">
        ...
        <!-- Funções do ambiente — checkboxes independentes -->
        <div class="form-group">
            <label><b>Funções do Ambiente</b></label>
            <p class="funcoes-hint">Um ambiente pode ter mais de uma função. Ex: biblioteca pode ter reserva e estoque ao mesmo tempo.</p>
            ...
            <div class="d-flex flex-column" style="gap:10px">
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="temSala">
                        <i class="fas fa-chalkboard mr-1 text-primary" style="color:#673ab7 !important"></i>
        ...
        <div class="form-group">
            ...
            <div class="toggle-tags">
                <input type="radio" id="porta_sim" name="temPorta" value="1" checked required>
                <label for="porta_sim" class="toggle-tag tag-sim">
                    <i class="fas fa-door-open mr-1"></i>Sim
                </label>
                <input type="radio" id="porta_nao" name="temPorta" value="0" required>
        ...
        <div class="form-group">
            ...
            <div class="toggle-tags">
                <input type="radio" id="ar_sim" name="temArCondicionado" value="1" required>
                <label for="ar_sim" class="toggle-tag tag-sim">
                    <i class="fas fa-snowflake mr-1"></i>Sim
                </label>
                <input type="radio" id="ar_nao" name="temArCondicionado" value="0" checked required>
