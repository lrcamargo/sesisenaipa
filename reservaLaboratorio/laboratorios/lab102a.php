...
if($nivel == 3 || $nivel == 4 || $nivel == 9 || $logado = 'administrator'){

echo "<br><br><b>Solicitante:</b><br>";

echo "<select name='solicitante'>";

$stmt = $pdo->prepare("SELECT nome FROM usuarios ORDER BY nome");
$stmt->execute();
...
echo "<input type='hidden' name='solicitante' value='".$logado."'>";

}

?>

<input type="hidden" name="lab" value="lego">
