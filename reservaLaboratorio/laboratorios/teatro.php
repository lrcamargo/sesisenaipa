        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventDisplay: 'block',
                    duration: { month: 2 },
                    events: { url: '../listareservas.php?lab=17',
                        failure: function() {
                    ...
                    eventClick: function(info) {
                        ...
                        if(info.event.extendedProps.descricao) {
                            $("#dadosModal #descricao").text(info.event.extendedProps.descricao);
    ...
    <body>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <b>Turno:</b><br/>
                <?php
                        if($nivel == 9 || $nivel == 6 || $nivel == 4 || $nivel == 8 || $nivel == 3) {
                            
                            echo "<input type='checkbox' class='form-control' id='manha' name='turno[]' value='manha' style='float:left;width:20px;height:20px'><label for='manha' style='float:left'>Manhã</label>";
                            echo "<input type='checkbox' class='form-control' id='tarde' name='turno[]' value='tarde' style='float:left;width:20px;height:20px;margin-left:5px'><label for='tarde' style='float:left'>Tarde</label>";
                            echo "<input type='checkbox' class='form-control' id='noite' name='turno[]' value='noite' style='float:left;width:20px;height:20px;margin-left:5px'><label for='noite' style='float:left'>Noite</label>";
                            
                        } else {
                            
                            echo "<input type='radio' class='form-control' id='manha' name='turno' value='manha' style='float:left;width:20px;height:20px;margin-left:5px'><label for='manha' style='float:left'>Manhã</label>";
                            echo "<input type='radio' class='form-control' id='tarde' name='turno' value='tarde' style='float:left;width:20px;height:20px;margin-left:5px'><label for='tarde' style='float:left'>Tarde</label>";
                            echo "<input type='radio' class='form-control' id='noite' name='turno' value='noite' style='float:left;width:20px;height:20px;margin-left:5px'><label for='noite' style='float:left'>Noite</label>";
                        }
                    ?>
                <div>
                ...
                <input type="radio" class='form-control' name="periodo" value="parcial" onChange="horarios()" style="display:block;float:left;width:20px;height:20px;margin-left:5px"><label for='parcial' style='float:left'>Só um período</label>
                <input type="radio" class='form-control' name="periodo" value="todo" onChange="horarios()" style="display:block;float:left;width:20px;height:20px;margin-left:5px"><label for='todo' style='float:left'>Todo o turno</label>
                <br/><br/>
                <b><span name="hInicio" style="display:none">Início: </span></b><input id="horainicio" class='form-control' name="horainicio" type="time" style="display:none;width:40%">
                <b><span name="hFim" style="display:none">Fim: </span></b><input id="horafim" class='form-control' name="horafim" type="time" style="display:none;width:40%"> <br/>
                ...
                <select class='form-control' name="turma">
                    <?php 
                        if($nivel == '4' || $nivel == '3' || $nivel == '9') {
                            echo "<option value='Outros Eventos'>Outros Eventos</option>";
                        }
                    ...
                    <?php
                        if($nivel == '4' || $nivel == '3' || $nivel == '9') {
                            ...
                            echo "<select class='form-control' name='solicitante'>";
                            echo "<option value='".$logado."'>Outros Eventos</option>";
                            ...
                            echo "<textarea class='form-control' name='descricao' style='width: 100%'></textarea>";
                        } else {
                            echo "<input type='hidden' name='solicitante' value='".$logado."'></input>";
                        }
                    ?>
                <input type="hidden" name="lab" value="teatro"></input>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="descricao-container" style="display: none;">
                            <b>Descrição</b>:<br/><span id="descricao" name="descricao"></span><br/><br/>
                        </div>
                    <div class="modal-footer">
