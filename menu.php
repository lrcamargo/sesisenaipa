<?php
    ...
    */
    if($nivelNorm == 'professor'){
        ...
        echo "<li class='item'>
                <a href='../main.php' class='menu-btn'>
                    <i class='fas fa-home'></i><span>Dashboard</span>
                </a>
            </li>";

        echo "<li class='item'>
                <a href='../reservaLaboratorio/principal.php' class='menu-btn'>
                    <i class='fas fa-calendar-day'></i><span>Reserva Laboratório</span>
                </a>
            </li>";
    ...
    */
    elseif($nivelNorm == 'sup pedagogica'){
        ...
        echo "<li class='item'>
                <a href='../gestaoUsuarios/index.php' class='menu-btn'>
                    <i class='fas fa-users'></i><span>Gestão Usuários</span>
                </a>
            </li>";
    ...
    */
    elseif($nivelNorm == 'sup tecnica'){
        ...
        echo "<li class='item'>
                <a href='../sirene/index.php' class='menu-btn'>
                    <i class='fas fa-bell'></i><span>Sirene</span>
                </a>
            </li>";
    }
